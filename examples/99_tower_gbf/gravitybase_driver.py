...
fanalysis     = os.path.join(mydir, 'analysis_options_gb.yaml')
fanalysis_opt = os.path.join(mydir, 'analysis_options_gravitybase.yaml')
fmodeling     = os.path.join(mydir, 'modeling_options_gravitybase.yaml')
fanalysis_tmp = 'analysis_options_temp_gb.yaml'
ftmp          = 'gb_optimized.yaml'
...
if make_plots:
    ...
    for ri, r in enumerate(ratings):
        ...
        for di, d in enumerate(depths):
            ...
            fout_path = os.path.join('outputs', 'gb_turb_output.npz')
